    ...
    <section id="about" className="py-12 sm:py-20 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto space-y-16 sm:space-y-24">
        ...
        <div className="scroll-mt-24">
          <CapsuleDivider className="mb-8 sm:mb-12 w-fit mx-auto sm:mx-0">{t.sections.experience}</CapsuleDivider>
          {EXPERIENCES[language].map((exp, idx) => (
            <div key={idx} className="mb-8 border-l-4 sm:border-l-8 border-[#52B2BF] pl-5 sm:pl-8 relative">
              <div className="absolute -left-[10px] sm:-left-[14px] top-1 w-4 sm:h-6 sm:w-6 h-4 bg-[#2D3243] dark:bg-[#52B2BF] rounded-full border-2 sm:border-4 border-white dark:border-[#12141d]"></div>
              ...
              <ul className="space-y-3 mt-4 text-sm sm:text-base">
                {exp.details.map((detail, dIdx) => (
                  <li key={dIdx} className="flex gap-3 text-[#2D3243]/80 dark:text-gray-300">
                    <span className="text-[#52B2BF] font-black shrink-0">/</span>
                    <span>{detail}</span>
                  </li>
                ))}
              </ul>
        ...
        {/* Academic Projects */}
        <div className="scroll-mt-24">
          <CapsuleDivider className="mb-8 sm:mb-12 w-fit mx-auto sm:mx-0">{t.sections.academicProjects}</CapsuleDivider>
        ...
        {/* Education */}
        <div className="scroll-mt-24">
          <CapsuleDivider className="mb-8 sm:mb-12 w-fit mx-auto sm:mx-0">{t.sections.education}</CapsuleDivider>
